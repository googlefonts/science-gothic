...
1. Run `gftools fix-nonhinting ScienceGothic[YOPQ,wdth,wght,slnt].ttf ScienceGothic[YOPQ,wdth,wght,slnt].ttf` per https://github.com/tphinney/science-gothic/issues/239
