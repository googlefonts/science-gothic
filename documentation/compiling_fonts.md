...
1. Make sure final font file is named correctly, per Google specs. e.g. ScienceGothic[YOPQ,slnt,wdth,wght].ttf
1. Remove MVAR table per https://github.com/tphinney/science-gothic/issues/244
----
